...
def run_algorithm(data):
    if data.selected_algorithm == "UCS":
        import UCS
        res = UCS.run(data, Heuristics.zero_heuristic)
        print(res)
    elif data.selected_algorithm == "IDS":
        import IDS
        res = IDS.run(data)
        print(res)
    elif data.selected_algorithm == "ASTAR":
        import UCS
        res = UCS.run(data, Heuristics.octile_distance)
        print(res)
    elif data.selected_algorithm == "IDASTAR":
        import IDAstar
        print(IDAstar.ida_star(data, Heuristics.octile_distance, StatsContainer()))
    else:
